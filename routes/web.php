...
|
*/
Route::get('product_image/{filename}/{company_id}/{product_id}', function ($filename,$company_id,$product_id) {
    $path = public_path("product_uploads/".$company_id."/".$product_id."/".$filename);
